...
* Purpose: store Job Ref No from jobs.html to the local storage , navigate the user to apply page on clicking 'apply' , 
            loading Job Ref No from the local storage on the Job Ref No input field on the apply.html page and making it readonly
